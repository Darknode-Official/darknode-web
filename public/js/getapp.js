...
export function renderDownloads(main) {
  ...
  const fallback = () => {
    builds.innerHTML = `<p class="muted" style="margin:0 0 10px">Live release info unavailable &mdash; download directly:</p>
      <div class="dl-btnrow">
        <a class="dl-osbtn" href="${REL_DL}/Sentinel-cli-linux" download><span class="dl-os">Linux</span><span class="dl-fmt">Nexus CLI</span></a>
        <a class="dl-osbtn" href="${REL_DL}/Sentinel-cli-windows.exe" download><span class="dl-os">Windows</span><span class="dl-fmt">Nexus CLI</span></a>
        <a class="dl-osbtn" href="${REL_DL}/Sentinel-cli-macos-arm64" download><span class="dl-os">macOS · Apple Silicon</span><span class="dl-fmt">Nexus CLI</span></a>
        <a class="dl-osbtn" href="${REL_DL}/Sentinel-cli-macos-x64" download><span class="dl-os">macOS · Intel</span><span class="dl-fmt">Nexus CLI</span></a>
      </div>`;
  };
