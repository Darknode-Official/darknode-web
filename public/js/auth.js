...
let _landing = null;
async function loadLanding() { if (!_landing) _landing = await import("/js/landing.js?v=20260924c"); return _landing; }
...
function renderHome(main, user, isOwner, show) {
  ...
  main.innerHTML = `
    ...
    <div class="stat-row">
      ...
      ${stat("475K+", "lines of code", "across the Darknode project")}
    </div>
    <div class="dash-ops">
...
function renderApp(user) {
  ...
  function show(sec, more, skipPush) {
    ...
    else if (sec === "ai") { import("/js/webai.js?v=20260924i").then(m => m.renderAI(main)); }
