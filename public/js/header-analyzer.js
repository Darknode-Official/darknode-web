...
var _haSecurityHeaders = [
  ...
  { name: 'Strict-Transport-Security', weight: 15, critical: true, desc: 'Forces HTTPS connections. Prevents SSL stripping attacks.', rec: 'Add: Strict-Transport-Security: max-age=31536000; includeSubDomains; preload', weak: function(v) { if (!v) return false; var m = /max-age=(\d+)/.exec(v); return !m || parseInt(m[1], 10) < 31536000; } },
